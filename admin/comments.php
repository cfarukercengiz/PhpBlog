...
<?php include "includes/admin_sidebar.php"; ?>
    ...
    <table class="table table-bordered">
        ...
        while ($row = mysqli_fetch_assoc($select_all_comments)) {
            ...
            while ($row2 = mysqli_fetch_assoc($select_post_id_query)) {
                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <input type="text" readonly class="form-control" name="comment_author"
                                           value="<?php echo $comment_author; ?>">
                                </div>
                                <div class="form-group">
                                    <label for="comment_email">Comment Email</label>
                                    <input type="text" readonly class="form-control" name="comment_email"
                                           value="<?php echo $comment_email; ?>">
                                </div>
                                <div class="form-group">
                                    <label for="comment_text">Comment Text</label>
                                    <textarea class="form-control" readonly name="comment_text" id="" cols="20"
                                              rows="5"><?php echo $row["comment_text"]; ?></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="comment_status">Comment Status</label>
                                    <input type="text" readonly class="form-control" name="comment_status"
                                           value="<?php echo $comment_status; ?>">
                                </div>
                                <div class="form-group">
                                    <label for="commented_post">Commented Post</label>
                                    <input type="text" readonly class="form-control" name="commented_post"
...
<?php
//COMMENT APPROVED - UNAPPROVED SECTION
